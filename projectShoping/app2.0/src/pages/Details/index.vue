        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(spuSaleAttrListItem, index) of spuSaleAttrList"
                :key="spuSaleAttrListItem.id"
              >
                ...
                <dd
                  ...
                  :key="sitem.id"
                  changepirce="0"
                  :class="{ active: sitem.isChecked == 1 }"
                >
                  {{ sitem.saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default {
  ...
  mounted() {
    ...
    if (id) {
      this.$store.dispatch("actions_GetGoodsInfo", id);
    }
    //获取副标签
  },
  computed: {
    ...mapState({
      getgoodsinfo: (state) => state.Details.getgoodsinfo,
    }),
